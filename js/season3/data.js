export const data = {
  ...
  "operators": [
	...
	{ id: 104, name: "뮤엘시스", oaths: ["조화"], stage: 6, trait: "획득 시", traitDescription: "<획득 시> 변형 구성체 1개(2개) 획득", img: "images/头像_缪尔赛思.png" },
	...
	{ id: 105, name: "로즈몬티스", oaths: ["정확","선견","협력"], stage: 6, trait: "기타", traitDescription: "공격력 및 체력 +20(40)%; 핵심 계약 중첩 3개당 이 오퍼레이터의 공격력 및 체력 +1(2)%.", img: "images/头像_迷迭香.png" },
	{ id: 106, name: "엑시아 더 뉴 커버넌트", oaths: ["라테라노"], stage: 6, trait: "획득 시", traitDescription: "<획득 시> 다음 준비 기간에 추가로 2원(4원) 획득", img: "images/头像_新约能天使.png" },
	{ id: 107, name: "루멘", oaths: ["조력","협력"], stage: 6, trait: "준비 기간 종료 시", traitDescription: "<준비 기간 종료 시> 준비 구역 내 오퍼레이터들의 소속되어있고 활성화된 맹약의 스택 +2(4)﻿", img: "images/头像_流明.png" },
	...
	{ id: 108, name: "치우바이", oaths: ["염국","급습"], stage: 6, trait: "기타", traitDescription: "[염국] [급습] 3중첩마다, 이 오퍼레이터는 속박되거나 기절한 적에게 1(2)% 증가된 피해를 입힙니다.", img: "images/头像_仇白.png" },
	...
	{ id: 109, name: "아스트젠 더 라이트체이서", oaths: ["영민","비전"], stage: 6, trait: "준비 기간 종료 시", traitDescription: "<준비 기간 종료 시> 이번 라운드에서 3원을 소모 할 때마다 활성화 된 [영민] [비전] +2(4)스택", img: "images/头像_溯光星源.png" },
	{ id: 110, name: "니어 더 래디언트 나이트", oaths: ["카시미어","급습"], stage: 6, trait: "기타", traitDescription: "전투 시작 시 자신과 자신 앞 오퍼레이터에게 [카시미어] 3스택마다 재배치 시간이 1.5(3)% 감소하는 특성 부여", img: "images/头像_耀骑士临光.png" },
	{ id: 111, name: "라플란드 더 데카텐차", oaths: ["시라쿠사"], stage: 6, trait: "기타", traitDescription: "전투 중 적을 처치하면 [시라쿠사] 스택 +2 (모든 [시라쿠사] 오퍼레이터에게 해당 특성 부여)", img: "images/头像_荒芜拉普兰德.png" },
	{ id: 112, name: "데겐블레허", oaths: ["쉐라그","카시미어","신속"], stage: 6, trait: "획득 시", traitDescription: "<획득 시> 자신 소속 맹약 스택 +8(16) (맹약 활성화될 필요 없음)", img: "images/头像_锏.png" },
	{ id: 113, name: "에이야퍄들라 더 크비트 아스카", oaths: ["조력"], stage: 6, trait: "기타", traitDescription: "스킬 발동 시 현재 활성화된 맹약 중 스택 수가 가장 많은 맹약의 스택 수+3(6)", img: "images/头像_纯烬艾雅法拉.png" },
],
  "tools": [
